...
@Spaces.register(Spaces.NAME.MODEL, 'CSPNet')
class CSPNet(nn.Module):
    def __init__(self):
        ...
        self.p3 = nn.ConvTranspose2d(512, 256, kernel_size=4, stride=2,
                                     padding=1)
        self.p4 = nn.ConvTranspose2d(1024, 256, kernel_size=4, stride=4,
                                     padding=0)
        self.p5 = nn.ConvTranspose2d(2048, 256, kernel_size=4, stride=4,
                                     padding=0)
